...
namespace MISA.Core.Services
{
    public class EmployeeService : BaseService<Employee>, IEmployeeService
    {
        ...
        public ServiceResult GetEmployeesFilter(int pageNumber, int pageSize, string employeeFilter)
        {
            ...
            var filterObject = _employeeRepository.GetEmployeesFilter(pageOffset, pageSize, employeeFilter);
        ...
        public ServiceResult ExportEmployees(Dictionary<string, string> mappingColumnFileExcel)
        {
            ServiceResult serviceResult = new ServiceResult();
            List<Employee> employees = (List<Employee>)_baseRepository.GetAll();
