...
namespace MISA.Core.Interfaces.Services
{
    public interface IBaseService<Entity>
    {
        ...
        /// </summary>
        /// <param name="mappingColumnFileExcel">map giữa cột file excel với property tương ứng của entity</param>
        /// <param name="fileTitle">Tiêu đề của File Excel</param>
        /// <returns></returns>
        ServiceResult ExportExcelFile(Dictionary<string, string> mappingColumnFileExcel, string fileTitle);
    }
}
